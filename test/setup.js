  ...
  global.dojo = {
    ...
    clone: function (mixin) {
      if (mixin instanceof Array) {
        //Recursively deep-copying arrays?  What could go wrong?
        return mixin.map(function (elem) {
          return global.dojo.clone(elem);
        });
      }
      return Object.assign({}, mixin);
    },
    hitch: function (ctx, method) {
      return method.bind(ctx, arguments);
    },
    connect: function () {},
    publish: function () {},
    subscribe: function () {},
