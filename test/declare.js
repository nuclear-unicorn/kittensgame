  ...
  var lang = {
    ...
    getProp: function (
      ...
      while (context && (p = parts[i++])) {
        context =
          p in context ? context[p] : create ? (context[p] = {}) : undefined;
      }
    ...
    setObject: function (name, value, context) {
      ...
      var parts = name.split("."),
        p = parts.pop(),
        obj = lang.getProp(parts, true, context);
      ...
      if (lang.isArray(name)) {
        return name.map(function (item) {
          if (lang.isObject(item)) {
            ...
            return lang.getProp(item.split("."), create, context);
          }
        });
      } else {
        parts = name.split(".");
        return lang.getProp(parts, create, context); // Object
      }
    },
