  ...
  com.nuclearunicorn.core.TabManager,
  {
    ...
    achievements: [
      ...
      },
      {
        ...
        condition: function () {
          return (
            this.game.ironWill &&
            !this.game.resPool.get("kittens").value &&
            this.game.bld.get("warehouse").val > 0
          );
        }
      },
      {
      ...
      },
      {
        ...
        condition: function () {
          return (
            this.game.ironWill &&
            !this.game.resPool.get("kittens").value &&
            this.game.bld.get("pasture").val >= 45
          );
        }
      },
      {
      ...
      },
      {
        ...
        condition: function () {
          return (
            this.game.ironWill &&
            !this.game.resPool.get("kittens").value &&
            this.game.bld.get("factory").val > 0
          );
        }
      },
      {
        ...
        condition: function () {
          return (
            this.game.ironWill && this.game.space.getProgram("moonMission").on
          );
        },
        starCondition: function () {
          return (
            this.game.ironWill &&
            this.game.space.getProgram("moonMission").on &&
            this.game.resPool.get("paragon").value < 10
          );
        }
      },
      {
        ...
        condition: function () {
          return (
            this.game.space.getProgram("orbitalLaunch").on &&
      ...
      },
      {
        ...
        condition: function () {
          return (
            ...
            this.game.village.maxKittens == 1
          );
        }
      },
      {
      ...
      },
      {
        ...
        condition: function () {
          return (
            this.game.village.getKittens() >= 50 && this.game.deadKittens == 0
          );
        }
      },
      {
        ...
        condition: function () {
          return (
            this.game.village.happiness >= 1.5 &&
            this.game.resPool.get("kittens").value > 35
          );
        },
        starCondition: function () {
          return (
            this.game.village.happiness >= 5 &&
            this.game.resPool.get("kittens").value > 35
          );
        }
      },
      ...
      },
      {
        ...
        condition: function () {
          return (
            ...
            this.game.calendar.darkFutureBeginning
          );
        },
        starCondition: function () {
          return (
            this.game.calendar.trueYear() >=
            this.game.calendar.darkFutureBeginning
          );
        }
      }
    ...
    badges: [
      ...
      },
      {
        ...
        condition: function () {
          return (
            this.game.resPool.get("kittens").value > 500 &&
      ...
      },
      {
        ...
        condition: function () {
          return (
            !this.game.space.getPlanet("moon").reached &&
    ...
    save: function (saveData) {
      saveData.achievements = this.filterMetadata(this.achievements, [
        "name",
        "unlocked",
        "starUnlocked"
      ]);
...
dojo.declare("classes.ui.AchievementsPanel", com.nuclearunicorn.game.ui.Panel, {
  ...
  render: function (container) {
    ...
    divHeader.innerHTML = $I("badges.header", [
      completedAchievements,
      totalAchievements
    ]);
    var stars = "";
...
dojo.declare(
  "com.nuclearunicorn.game.ui.tab.AchTab",
  com.nuclearunicorn.game.ui.tab,
  {
    constructor: function () {},

    render: function (container) {
      this.achievementsPanel = new classes.ui.AchievementsPanel(
        $I("achievements.panel.label"),
      ...
      this.badgesPanel = new classes.ui.BadgesPanel(
        $I("badges.panel.label"),
        this.game.achievements
      );
