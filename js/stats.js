  ...
  com.nuclearunicorn.core.TabManager,
  {
    ...
    stats: [
      ...
      },
      {
        ...
        calculate: function (game) {
          return game.stats.getStat("totalYears").val != 0
            ? game.stats.getStat("totalKittens").val /
                Math.ceil(game.stats.getStat("totalYears").val / 100)
            : 0;
        },
        unlocked: false
      },
    ...
    statsCurrent: [
      ...
      },
      {
        ...
        val: 0,
        calculate: function (game) {
          return game.calendar.year != 0
            ? game.resPool.get("kittens").value /
                Math.ceil(game.calendar.year / 100)
            : 0;
        }
      },
      {
        ...
        val: 0,
        calculate: function (game) {
          return game.toDisplaySeconds(
            (game.calendar.trueYear() *
              game.calendar.seasonsPerYear *
              game.calendar.daysPerSeason *
    ...
    save: function (saveData) {
      ...
      saveData.statsCurrent = this.filterMetadata(this.statsCurrent, [
        "name",
        "val"
      ]);
    },
          ...
          "td",
          {
            innerHTML: stat.unlocked
              ? typeof stat.val == "number"
                ? this.game.getDisplayValueExt(stat.val)
                : stat.val
              : ""
          },
          tr
