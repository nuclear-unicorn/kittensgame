...
dojo.declare(
  "classes.managers.BuildingsManager",
  com.nuclearunicorn.core.TabManager,
  {
    ...
    buildingsData: [
        ...
        stages: [
          ...
          },
          {
            ...
            calculateEffects: function (self, game) {
              self.effects = {
                energyProduction: self.calculateEnergyProduction(
                  game,
            ...
            calculateEnergyProduction: function (game, season) {
              ...
              if (
                (season == 3 && seasonRatio == 1) ||
                (season != 1 && seasonRatio == 2)
              ) {
        ...
        calculateEffects: function (self, game) {
          ...
          if (self.stage == 0) {
            ...
            effects["energyProduction"] *=
              1 + game.getEffect("hydroPlantRatio");
      ...
      //----------------------------------- Science ----------------------------------------
      {
        ...
        calculateEffects: function (self, game) {
          ...
          effects["scienceMax"] *=
            1 + game.bld.get("observatory").on * libraryRatio;
          ...
          if (self.stage == 1) {
            ...
            var biolabBonus =
              game.bld.get("biolab").val * game.getEffect("uplinkDCRatio");
            ...
            if (game.workshop.get("machineLearning").researched) {
              ...
              dataCenterAIRatio *=
                1 + game.getEffect("aiCoreUpgradeBonus") || 0;
              effects["scienceMaxCompendia"] *=
                1 + game.bld.get("aiCore").on * dataCenterAIRatio;
              effects["scienceMax"] *=
                1 + game.bld.get("aiCore").on * dataCenterAIRatio;
              effects["cultureMax"] *=
                1 + game.bld.get("aiCore").on * dataCenterAIRatio;
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          if (
            game.workshop.getZebraUpgrade("minerologyDepartment").researched
          ) {
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          ...
          self.effects["scienceMax"] =
            ratio * (game.workshop.get("astrolabe").researched ? 1500 : 1000);
        },
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          if (game.workshop.get("biofuel").researched) {
            ...
            self.effects["oilPerTickProd"] =
              0.02 * (1 + game.getEffect("biofuelRatio"));
          ...
          if (
            game.workshop.get("uplink").researched &&
            game.bld.get("library").stage == 1
          ) {
            var datacenterBonus =
              game.bld.get("library").val * game.getEffect("uplinkLabRatio");
          ...
          if (game.workshop.get("biofuel").researched) {
            var amt = game.resPool.getAmtDependsOnStock(
              [
                {
                  res: "catnip",
                  amt: -self.effectsCalculated["catnipPerTickCon"]
                }
              ],
              self.on
            );
            for (var i in self.effects) {
              if (i == "catnipPerTickCon" || i == "oilPerTickProd") {
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          ...
          if (cargoShips.researched) {
            ...
            var limit =
              2.25 + game.getEffect("shipLimit") * game.bld.get("reactor").on;
            var ratio =
              1 +
              game.getLimitedDR(
                cargoShips.effects["harborRatio"] * shipVal,
                limit
              );
        ...
        action: function (self, game) {
          ...
          var amt = game.resPool.getAmtDependsOnStock(
            [
              ...
              {
                res: "minerals",
                amt: -self.effectsCalculated["mineralsPerTickCon"]
              }
            ],
            self.on
          );
      ...
      },
      {
        ...
        basicProductionCalculation: function (self, game) {
          ...
          self.effects["titaniumPerTickAutoprod"] =
            0.0005 * (1 + calcinerRatio * 3);

          self.effectsCalculated["mineralsPerTickCon"] =
            self.effects["mineralsPerTickCon"];
          self.effectsCalculated["oilPerTickCon"] =
            self.effects["oilPerTickCon"];
          self.effectsCalculated["ironPerTickAutoprod"] =
            self.effects["ironPerTickAutoprod"];
          self.effectsCalculated["titaniumPerTickAutoprod"] =
            self.effects["titaniumPerTickAutoprod"];
        },
        ...
        steelProductionCalculation: function (self, game, calledByAction) {
          ...
          if (steelRatio == 0) {
            ...
            self.description =
              $I("buildings.calciner.desc") +
              "<br>" +
              $I("buildings.calciner.desc.automation", [
                (100 * steelRatio).toFixed()
              ]);
            ...
            if (self.isAutomationEnabled) {
              ...
              var difference =
                self.effects["ironPerTickAutoprod"] *
                steelRatio *
                game.bld.getAutoProductionRatio(); //HACK
              // Cycle Effect
              var effectsTemp = {};
              ...
              if (calledByAction) {
                ...
                self.effects["steelPerTickProd"] *=
                  amt *
                  (1 +
                    game.getCraftRatio() *
                      game.getEffect("calcinerSteelCraftRatio") +
                    game.bld.get("reactor").on *
                      game.getEffect("calcinerSteelReactorBonus"));
        ...
        action: function (self, game) {
          ...
          self.effects["mineralsPerTickCon"] =
            self.effectsCalculated["mineralsPerTickCon"] * amt;
          self.effects["oilPerTickCon"] =
            self.effectsCalculated["oilPerTickCon"] * amt;
          self.effects["ironPerTickAutoprod"] =
            self.effectsCalculated["ironPerTickAutoprod"] * amt;
          self.effects["titaniumPerTickAutoprod"] =
            self.effectsCalculated["titaniumPerTickAutoprod"] * amt;
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          self.effects["coalRatioGlobal"] =
            -0.8 + game.getEffect("coalRatioGlobalReduction");
          ...
          if (game.workshop.get("factoryAutomation").researched) {
            self.description =
              $I("buildings.steamworks.desc") +
              "<br>" +
              $I("buildings.steamworks.desc.automation");
          } else {
        ...
        action: function (self, game) {
          ...
          var automationRate = Math.min(
            baseAutomationRate * (self.on + 1),
            0.9
          );

          var newCrafter = function (
            consumedResource,
            craftedResourceName,
            isAllowed
          ) {
            ...
            return {
              numberOfCrafts:
                ...
                consumedResource.value >=
                  consumedResource.maxValue * (1 - baseAutomationRate)
                  ? Math.max(
                      0,
                      Math.floor(
                        consumedQuantity /
                          game.workshop.getCraft(craftedResourceName).prices[0]
                            .val
                      )
                    )
                  : 0,
              craft: function () {
                if (this.numberOfCrafts > 0) {
                  ...
                  // Automated production, metallurgist leader won't help here
                  game.msg(
                    $I("bld.msg.automation." + craftedResourceName + "s", [
                      game.getDisplayValueExt(consumedQuantity),
                      game.getDisplayValueExt(
                        this.numberOfCrafts * (1 + game.getCraftRatio())
                      )
                    ]),
                    null,
                    "workshopAutomation",
          ...
          if (
            beamCrafter.numberOfCrafts == 0 &&
            slabCrafter.numberOfCrafts == 0 &&
            plateCrafter.numberOfCrafts == 0
          ) {
            return;
          }
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          self.effects["woodRatio"] =
            0.1 + game.getEffect("lumberMillRatio") * 0.1;
        },
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          ...
          if (hasPumpjack) {
            self.description =
              $I("buildings.oilWell.desc") +
              "<br>" +
              $I("buildings.oilWell.desc.automation");
            if (self.isAutomationEnabled == null) {
              //force non-null value
              self.isAutomationEnabled = true;
            }
          ...
          self.effects["energyConsumption"] = self.isAutomationEnabled ? 1 : 0;
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          var effects = {
            craftRatio:
              0.05 * (1 + game.getEffect("environmentFactoryCraftBonus"))
          };

          if (game.workshop.get("factoryLogistics").researched) {
            effects["craftRatio"] =
              0.06 * (1 + game.getEffect("environmentFactoryCraftBonus"));
          }

          effects["energyConsumption"] = 2;
          if (game.workshop.get("carbonSequestration").researched) {
            self.description =
              $I("buildings.factory.desc") +
              "<br>" +
              $I("buildings.factory.desc.automation");
            self.isAutomationEnabled =
              self.isAutomationEnabled === null
                ? true
                : self.isAutomationEnabled;
          } else {
          ...
          effects["cathPollutionPerTickProd"] = self.isAutomationEnabled
            ? 0
            : game.workshop.get("carbonSequestration").researched
              ? 1
              : 2;
          effects["cathPollutionPerTickCon"] = self.isAutomationEnabled
            ? -2
            : 0;
          self.effects = effects;
        }
      },
      {
        ...
        isAutomationEnabled: null,
        calculateEffects: function (self, game) {
          self.effects["uraniumPerTick"] =
            -0.001 * (1 - game.getEffect("uraniumRatio"));
          if (game.workshop.get("thoriumReactors").researched) {
            self.description =
              $I("buildings.reactor.desc") +
              "<br>" +
              $I("buildings.reactor.desc.automation");
            if (self.isAutomationEnabled == null) {
        ...
        action: function (self, game) {
          if (
            game.resPool.get("uranium").value +
              self.effects["uraniumPerTick"] <=
            0
          ) {
            self.on = 0;
          ...
          var stopAutomation =
            ...
            (self.isAutomationEnabled &&
              game.resPool.get("thorium").value <= 0);
          self.effects["thoriumPerTick"] = stopAutomation
            ? 0
            : game.getEffect("reactorThoriumPerTick");

          var energyRatio = 1 + game.getEffect("reactorEnergyRatio");
          if (stopAutomation) {
            energyRatio -=
              game.workshop.get("thoriumReactors").effects[
                "reactorEnergyRatio"
              ];
            self.isAutomationEnabled = false;
          }
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          self.effects["standingRatio"] = game.workshop.get("caravanserai")
            .researched
            ? 0.0035
            : 0;
        },
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          self.effects["goldMax"] =
            100 * (1 + game.getEffect("warehouseRatio"));
        },
        lackResConvert: false,
        action: function (self, game) {
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          self.effects = {
            catnipPerTickCon:
              -1 * (1 + game.getEffect("breweryConsumptionRatio")),
            spicePerTickCon:
              -0.1 * (1 + game.getEffect("breweryConsumptionRatio")),
            festivalRatio: 0.01,
            festivalArrivalRatio: 0.001
          };
        ...
        action: function (self, game) {
          ...
          self.effects["catnipPerTickCon"] =
            self.effectsCalculated["catnipPerTickCon"] * amt;
          self.effects["spicePerTickCon"] =
            self.effectsCalculated["spicePerTickCon"] * amt;
          self.effects["festivalRatio"] =
            self.effectsCalculated["festivalRatio"] * amt;
          self.effects["festivalArrivalRatio"] =
            self.effectsCalculated["festivalArrivalRatio"] * amt;
          return amt;
        },
        ...
        action: function (self, game) {
          ...
          if (self.stage == 1) {
            ...
            if (energyRatio > 1) {
              ...
              btower.effects["culturePerTickBase"] =
                Math.floor(energyRatio * 1000) / 1000;
              btower.effects["cultureMax"] =
                Math.floor(300 * energyRatio * 1000) / 1000;
            }

            var broadcastTowerRatio = game.getEffect("broadcastTowerRatio");
            var totalRatio =
              game.space.getBuilding("sattelite").on * broadcastTowerRatio;
...

      {
        ...
        calculateEffects: function (self, game) {
          ...
          effects["cultureMaxRatio"] =
            0.08 + game.getEffect("cultureMaxRatioBonus");
          self.effects = effects;
          if (self.val) {
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          ...
          self.effects["temporalFluxProduction"] = game.getEffect(
      ...
      },
      {
        ...
        updateEffects: function (self, game) {
          ...
          var gflopsPerTickBase =
            0.02 * (1 + game.getEffect("aiCoreProductivness"));
          self.effects["gflopsPerTickBase"] = gflopsPerTickBase;
          self.effects["aiLevel"] = Math.round(
            Math.log(Math.max(game.resPool.get("gflops").value, 1))
          );
        },
        action: function (self, game) {
          game.resPool.get("gflops").value +=
            self.effects["gflopsPerTickBase"] * self.on;
          self.updateEffects(self, game);
        },
        flavor: $I("buildings.aicore.flavor"),
        canSell: function (self, game) {
          if (
            game.science.getPolicy("transkittenism").researched == true ||
            self.effects["aiLevel"] < 15
          ) {
            return true;
          }
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          if (game.workshop.getZebraUpgrade("bloodstoneInstitute").researched) {
            self.effects["bloodstoneRatio"] =
              (0.01 *
                game.getLimitedDR(
                  self.on * (game.ironWill ? 1 : 0.1) * (game.karmaZebras + 1),
                  game.getEffect("zebraPreparations") + 40
                )) /
              self.on;
          }
          if (self.val) {
      ...
      },
      {
        ...
        calculateEffects: function (self, game) {
          if (
            game.workshop.getZebraUpgrade("whispers").researched &&
            self.on > 0 &&
            self.isAutomationEnabled == null
          ) {
            self.isAutomationEnabled = true;
    ...
    getAutoProductionRatio: function () {
      ...
      var swRatio =
        steamworks.on > 0
          ? 1 +
            steamworks.effects["magnetoBoostRatio"] * this.get("steamworks").on
          : 1;
      autoProdRatio *= 1 + this.game.getEffect("magnetoRatio") * swRatio;

      // paragon (25%)
      autoProdRatio *=
        1 + this.game.prestige.getParagonProductionRatio() * 0.05;
    ...
    getPriceRatioWithAccessor: function (bld) {
      ...
      var ratioDiff =
        this.game.getEffect(bld.meta.name + "PriceRatio") +
    ...
    getPricesWithAccessor: function (bld, additionalBought) {
      ...
      var pricesDiscount = this.game.getLimitedDR(
        this.game.getEffect(bld.get("name") + "CostReduction"),
        1
      );
      var priceModifier = 1 - pricesDiscount;
      var fakeBought =
        this.game.getEffect(bld.get("name") + "FakeBought") + additionalBought;

      for (var i = 0; i < bldPrices.length; i++) {
        var resPriceDiscount = this.game.getLimitedDR(
          this.game.getEffect(bldPrices[i].name + "CostReduction"),
          1
        );
        ...
        prices.push({
          val:
            bldPrices[i].val *
            Math.pow(ratio, bld.get("val") + fakeBought) *
            priceModifier *
            resPriceModifier,
      ...
      if (
        this.game.challenges.isActive("blackSky") &&
      ...
      if (
        ...
        for (var i = 0; i < prices.length; i++) {
          if (prices[i].name == "blueprint") {
            prices[i].val =
              this.game.challenges.getChallenge("pacifism").on * 5 + 1;
          }
        }
      }
      if (
        this.game.challenges.isActive("postApocalypse") &&
        bld.get("name") == "field" &&
        this.getPollutionLevel() >= 5 &&
        bld.get("val") >=
          Math.max(
            95 -
              this.game.time.getVSU("usedCryochambers").val -
              this.getPollutionLevel(),
            7 + (this.game.ironWill ? 8 : 0)
          )
      ) {
        var builtWithUnobtanium = Math.max(
          bld.get("val") + this.game.time.getVSU("usedCryochambers").val - 100,
          0
        );
        prices.push({
    ...
    calculatePollutionEffects: function () {
      ...
      if (pollutionLevel >= 4) {
        this.pollutionEffects["catnipPollutionRatio"] =
          this.game.getLimitedDR(-0.5 - 0.1 * Math.log(pollution), 10) / 10;
        this.pollutionEffects["pollutionHappines"] = -Math.log(pollution) * 1.2;
        this.pollutionEffects["pollutionArrivalSlowdown"] =
          Math.log10(this.game.bld.cathPollution) * 1.2;
        this.pollutionEffects["solarRevolutionPollution"] = -Math.min(
          (1e-10 * (pollution - POL_LBASE * 1000)) / 9,
          1
        ); //linear HERE AND ONLY HERE
      } else if (pollutionLevel == 3) {
        this.pollutionEffects["catnipPollutionRatio"] =
          this.game.getLimitedDR(-0.5 - 0.1 * Math.log(pollution), 10) / 10;
        this.pollutionEffects["pollutionHappines"] =
          -Math.log(pollution) * 1.18;
        this.pollutionEffects["pollutionArrivalSlowdown"] =
          Math.log10(this.game.bld.cathPollution) * 1.11;
        this.pollutionEffects["solarRevolutionPollution"] = 0;
      } else if (pollutionLevel == 2) {
        this.pollutionEffects["catnipPollutionRatio"] =
          this.game.getLimitedDR(-0.5 - 0.1 * Math.log(pollution), 10) / 10;
        this.pollutionEffects["pollutionHappines"] =
          -Math.log(pollution) * 1.08;
        this.pollutionEffects["pollutionArrivalSlowdown"] =
          pollution >= (POL_LBASE * 100) / 2
            ? 1 + 1.68e-8 * (pollution - (POL_LBASE * 100) / 2)
            : 0; //linear
        this.pollutionEffects["solarRevolutionPollution"] = 0;
        ...
        this.pollutionEffects["pollutionHappines"] =
          pollution >= (POL_LBASE * 10) / 2
            ? -0.00000032 * (pollution - (POL_LBASE * 10) / 2)
            : 0; //linear
    ...
    update: function () {
      ...
      for (var i = 0; i < this.buildingsData.length; i++) {
        ...
        if (
          bld.action &&
          (bld.on > 0 || bld.name == "biolab" || bld.name == "aiCore")
        ) {
      ...
      if (building.prices.length && typeof unlockRatio == "number") {
        for (var i = 0; i < building.prices.length; i++) {
          ...
          if (res.value < price.val * unlockRatio) {
            // 30% required to unlock structure
            isUnlocked = false;
            break;
          }
        }
    ...
    save: function (saveData) {
      saveData.buildings = this.filterMetadata(this.buildingsData, [
        "name",
        "unlocked",
        "val",
        "on",
    ...
    load: function (saveData) {
      this.groupBuildings = saveData.bldData
        ? saveData.bldData.groupBuildings
        : false;
    ...
    resetState: function () {
      for (var i = 0; i < this.buildingsData.length; i++) {
        ...
        if (typeof bld.stages == "object") {
          bld.stage = 0;
          for (var j = 1; j < bld.stages.length; j++) {
            //stages[0] should always be unlocked
    ...
    getCleanEnergy: function () {
      ...
      var cleanEnergyProduced =
        solarFarm.stage == 1 && solarFarm.stages[1].effects
          ? solarFarm.stages[1].effects["energyProduction"] * solarFarm.on
          : 0;
      cleanEnergyProduced +=
        hydroPlant.stage == 1 && hydroPlant.stages[1].effects
          ? hydroPlant.stages[1].effects["energyProduction"] * hydroPlant.on
          : 0;
      cleanEnergyProduced +=
        (reactor.effects["energyProduction"] * reactor.on) / 2;
      cleanEnergyProduced +=
        sattelite.effects["energyProduction"] * sattelite.on;
    ...
    getPollutingEnergy: function () {
      ...
      var polutinEnergy =
        magneto.effects["energyProduction"] * magneto.on +
        steamworks.effects["energyProduction"] * steamworks.on;
    ...
    getCleanEnergyProdRatio: function () {
      ...
      return (
        this.getCleanEnergy() /
        (this.getCleanEnergy() + this.getPollutingEnergy())
      );
    },
    ...
    getPollutionLevel: function (cathPollution) {
      ...
      return Math.max(
        Math.floor(
          Math.log10((cathPollution * 10) / this.getPollutionLevelBase())
        ),
        0
      );
    },
    ...
    getUndissipatedPollutionPerTick: function () {
      return (
        this.game.getEffect("cathPollutionPerTickProd") *
          this.getPollutionRatio() *
          (1 + this.game.getEffect("cathPollutionRatio")) +
        this.game.getEffect("cathPollutionPerTickCon")
      );
    },
    cacheCathPollutionPerTick: function () {
      this.cathPollutionPerTick =
        this.getUndissipatedPollutionPerTick() -
        this.cathPollution * this.pollutionEffects["pollutionDissipationRatio"];
    },
    getEquilibriumPollution: function () {
      ...
      if (this.pollutionEffects["pollutionDissipationRatio"]) {
        return (
          this.getUndissipatedPollutionPerTick() /
          this.pollutionEffects["pollutionDissipationRatio"]
        );
    ...
    cathPollutionFastForward: function (ticks, simplified) {
      if (simplified || !this.pollutionEffects["pollutionDissipationRatio"]) {
        ...
        this.cathPollution = Math.max(
          ((this.cathPollution * pdr + uppt) * expon - uppt) / pdr,
          0
        );
      }
    },
    ...
    fastforward: function (daysOffset) {
      ...
      if (
        steamworks.on < 1 ||
        !game.workshop.get("factoryAutomation").researched
      ) {
        return;
      }
      ...
      // Cap automation at 90% of resource cap to prevent trying to craft more than you have
      var automationRate = Math.min(
        baseAutomationRate * (steamworks.on + 1),
        0.9
      );

      var automationDelay =
        (this.game.calendar.daysPerSeason * this.game.calendar.seasonsPerYear) /
        (this.game.workshop.get("advancedAutomation").researched ? 2 : 1);
      ...
      function newCrafter(consumedResource, craftedResourceName, isAllowed) {
        ...
        var consumableQuantityThreshold =
          consumedResource.maxValue * (1 - baseAutomationRate);
        ...
        while (
          isAllowed &&
          remainingAutomations-- > 0 &&
          consumableQuantity >= consumableQuantityThreshold &&
          (numberOfCraftsForCurrentAutomation = Math.floor(
            (Math.min(consumableQuantity, consumedResource.maxValue) *
              automationRate) /
              price
          )) > 0
        ) {
      ...
      if (game.opts.enableRedshiftGflops) {
        ...
        game.resPool.get("gflops").value +=
          aiCore.effects["gflopsPerTickBase"] *
          aiCore.on *
          daysOffset *
    ...
    undo: function (data) {
      ...
      if (data.action == "build") {
        ...
        if (typeof bld.stages == "object") {
          props.controller = new classes.ui.btn.StagingBldBtnController(
            this.game
          );
        } else {
          props.controller = new classes.ui.btn.BuildingBtnModernController(
            this.game
          );
        }
        ...
        props.controller.sellInternal(
          model,
          model.metadata.val - amt,
          false /*requireSellLink*/
        );
        ...
        var props = {
          //We need these props for later when we get the model.
          key: bld.name,
          name: bld.label,
          description: bld.description,
          building: bld.name
        ...
        if (typeof bld.stages == "object") {
          //Be sure to get the proper type of controller for the building we're working with
          props.controller = new classes.ui.btn.StagingBldBtnController(
            this.game
          );
        } else {
        ...
        this.game.render();
      } else if (data.action == "deltagrade") {
        //Generic term for upgrading/downgrading
...
dojo.declare(
  ...
  com.nuclearunicorn.game.ui.ButtonModernController,
  {
    buyItem: function (model, event, callback) {
      ...
      this.game.gatherTimeoutHandler = setTimeout(function () {
      ...
      callback(true /*itemBought*/, {
        reason:
          "item-is-free" /*It costs no resources to gather catnip, so we can't fail to buy it*/
      });
    }
  }
);
...
dojo.declare(
  "classes.game.ui.RefineCatnipButton",
  ...
  com.nuclearunicorn.game.ui.BuildingStackableBtnController,
  {
    getMetadata: function (model) {
      ...
      if (!model.metaAccessor) {
        console.warn(
          "Unable to get building metadata, invalid id or options:",
          model.options.building
        );
        return null;
      }
  ...
  classes.ui.btn.BuildingBtnModernController,
  {
    ...
    downgrade: function (model) {
      if (this.game.opts.noConfirm) {
        ...
        this.game.ui.confirm(
          "",
          $I("buildings.downgrade.confirmation.msg"),
          function () {
    ...
    upgrade: function (model) {
      if (this.game.opts.noConfirm) {
        ...
        this.game.ui.confirm(
          "",
          $I("buildings.upgrade.confirmation.msg"),
          function () {
            self.deltagrade.apply(self, [model, +1]);
          }
        );
    ...
    deltagrade: function (model, delta) {
      ...
      if (metadataRaw.val > 0) {
        //Sell until 0 are left (to refund to the player)
        undo.addEvent("building", {
          //The order of these undo events matters A LOT
          action: "sell",
          metaId: model.options.building,
          val: metadataRaw.val
        });
      ...
      if (metadataRaw.stage) {
        metadataRaw.stage = Math.max(0, metadataRaw.stage + delta);
      } else {
        metadataRaw.stage = Math.max(0, delta);
      }
...
dojo.declare(
  "classes.ui.btn.StagingBldBtn",
  com.nuclearunicorn.game.ui.BuildingStackableBtn,
  {
    stageLinks: null,
...
dojo.declare(
  "com.nuclearunicorn.game.ui.tab.BuildingsModern",
  com.nuclearunicorn.game.ui.tab,
  {
    ...
    render: function (content) {
      ...
      for (var i = 0; i < groups.length; i++) {
        ...
        if (!groups[i].buildings.length) {
          //empty groups are visible by default
          hasVisibleBldngs = true;
        }

        var separator = null;
        if (i != 0) {
          separator = dojo.create(
            "span",
            {
              innerHTML: " &#183; ",
              style: {
        ...
        dojo.connect(
          ...
          "onclick",
          this,
          dojo.partial(function (groupName) {
      ...
      var groupContainer = dojo.create(
        "div",
        { className: "bldGroupContainer" },
        topContainer
      );
            ...
            btn = new classes.ui.btn.StagingBldBtn(
              {
                ...
                building: bld.name,
                twoRow: this.twoRows,
                controller: new classes.ui.btn.StagingBldBtnController(
                  this.game
                )
              },
              this.game
            ...
            btn = new com.nuclearunicorn.game.ui.BuildingStackableBtn(
              {
                ...
                building: bld.name,
                twoRow: this.twoRows,
                controller: new classes.ui.btn.BuildingBtnModernController(
                  this.game
                )
              },
              this.game
      ...
      var btn = new com.nuclearunicorn.game.ui.ButtonModern(
        {
          ...
          controller: new classes.game.ui.GatherCatnipButtonController(
            this.game
          ),
      ...
      var btn = new classes.game.ui.RefineCatnipButton(
        {
          ...
          controller: new classes.game.ui.RefineCatnipButtonController(
            this.game
          ),
          handler: function (btn) {
